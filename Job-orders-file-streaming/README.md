# Job-orders-file-streaming

This folder defines all source code for the 'Job-orders-file-streaming' pipeline:
...
* Take a look at the sample under "sample_users_job_orders_file_streaming.py" to get familiar with the syntax.
